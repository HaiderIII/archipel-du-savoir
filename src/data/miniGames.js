...

  {
    ...
    content: {
      ...
      items: [
        ...
        { label: "Langues du monde", cat: "GÉO", emoji: "🗣️" },
        { label: "Prix Nobel de littérature", cat: "LIT", emoji: "📚" },
        { label: "Grandes découvertes scientifiques", cat: "SCIENCE", emoji: "🔬" },
        { label: "Batailles célèbres de l'histoire", cat: "HIST", emoji: "⚔️" },
        { label: "Philosophes antiques", cat: "PHILO", emoji: "📖" },
        { label: "Sports olympiques d'été", cat: "SPORT", emoji: "🏅" },
        { label: "Monuments du monde classés à l'UNESCO", cat: "ART", emoji: "🏛️" },
        { label: "Inventions du XXe siècle", cat: "SCIENCE", emoji: "💡" },
      ],
    },
  },
