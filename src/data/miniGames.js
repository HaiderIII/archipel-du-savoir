...
export const MG = [
...

  {
    ...
    content: {
      ...
      items: [
        ...
        { q: "Quel empire a bâti le Colisée de Rome ?", r: "L'Empire romain", cat: "HIST" },
        { q: "Qui a composé la 5e Symphonie ?", r: "Ludwig van Beethoven", cat: "ART" },
        { q: "Quelle est la capitale de l'Argentine ?", r: "Buenos Aires", cat: "GÉO" },
        { q: "Qui a écrit « Les Misérables » ?", r: "Victor Hugo", cat: "LIT" },
        { q: "Quel gaz compose ~78 % de l'atmosphère terrestre ?", r: "L'azote (N₂)", cat: "SCIENCE" },
        { q: "En quelle année a eu lieu la Révolution française ?", r: "1789", cat: "HIST" },
        { q: "Quelle civilisation a inventé la démocratie ?", r: "La Grèce antique (Athènes)", cat: "HIST" },
        { q: "Quel mathématicien a démontré que √2 est irrationnel ?", r: "Hippase de Métaponte (École pythagoricienne)", cat: "SCIENCE" },
        { q: "Quelle est la montagne la plus haute du monde ?", r: "L'Everest (8 849 m)", cat: "GÉO" },
        { q: "Qui a écrit « L'Art de la guerre » ?", r: "Sun Tzu", cat: "HIST" },
      ],
    },
  },

  {
    ...
    content: {
      ...
      items: [
        { label: "Auteurs français de littérature", cat: "LIT", emoji: "📚", answers: ["Victor Hugo", "Molière", "Gustave Flaubert", "Albert Camus", "Marcel Proust", "Émile Zola", "Stendhal", "Honoré de Balzac", "Voltaire", "Jean Racine"] },
        { label: "Empereurs romains", cat: "HIST", emoji: "🏛️", answers: ["Auguste", "César (dictateur)", "Néron", "Marc Aurèle", "Caligula", "Tibère", "Hadrien", "Vespasien", "Domitien", "Commode"] },
        { label: "Pays d'Afrique", cat: "GÉO", emoji: "🌍", answers: ["Maroc", "Égypte", "Nigeria", "Éthiopie", "Sénégal", "Côte d'Ivoire", "Kenya", "Tanzanie", "Algérie", "Afrique du Sud"] },
        { label: "Éléments du tableau périodique", cat: "SCIENCE", emoji: "🔬", answers: ["Hydrogène", "Oxygène", "Carbone", "Fer", "Or", "Uranium", "Hélium", "Sodium", "Chlore", "Azote"] },
        { label: "Capitales européennes", cat: "GÉO", emoji: "🗺️", answers: ["Paris", "Berlin", "Rome", "Madrid", "Varsovie", "Vienne", "Amsterdam", "Prague", "Budapest", "Bruxelles"] },
        { label: "Peintres et artistes célèbres", cat: "ART", emoji: "🎨", answers: ["Léonard de Vinci", "Picasso", "Rembrandt", "Monet", "Van Gogh", "Michel-Ange", "Caravage", "Frida Kahlo", "Dalí", "Raphaël"] },
        { label: "Dieux de la mythologie grecque", cat: "MYTH", emoji: "📖", answers: ["Zeus", "Poséidon", "Athéna", "Apollon", "Artémis", "Hermès", "Arès", "Héra", "Héphaïstos", "Aphrodite"] },
        { label: "Organes du corps humain", cat: "SCIENCE", emoji: "🧪", answers: ["Cœur", "Poumon", "Foie", "Rein", "Cerveau", "Estomac", "Intestin", "Pancréas", "Rate", "Vésicule biliaire"] },
        { label: "Fleuves du monde", cat: "GÉO", emoji: "🌊", answers: ["Nil", "Amazone", "Yangtsé", "Mississippi", "Volga", "Gange", "Danube", "Congo", "Niger", "Rhône"] },
        { label: "Compositeurs de musique classique", cat: "ART", emoji: "🎵", answers: ["Mozart", "Beethoven", "Bach", "Chopin", "Vivaldi", "Schubert", "Haendel", "Brahms", "Tchaïkovski", "Liszt"] },
        { label: "Présidents de la Ve République française", cat: "POLITIQUE", emoji: "⚖️", answers: ["De Gaulle", "Pompidou", "Giscard d'Estaing", "Mitterrand", "Chirac", "Sarkozy", "Hollande", "Macron"] },
        { label: "Guerres et conflits célèbres de l'histoire", cat: "HIST", emoji: "📜", answers: ["Guerre de Cent Ans", "Première Guerre mondiale", "Deuxième Guerre mondiale", "Guerre du Péloponnèse", "Guerre froide", "Croisades", "Guerre de Troie", "Guerre de Sécession"] },
        { label: "Films d'animation Disney/Pixar", cat: "POP", emoji: "🎬", answers: ["Le Roi Lion", "Toy Story", "La Reine des neiges", "Aladdin", "Coco", "Là-haut", "Mulan", "WALL-E", "Ratatouille", "Bambi"] },
        { label: "Jeux vidéo célèbres (toute époque)", cat: "POP", emoji: "🎮", answers: ["Minecraft", "Tetris", "Super Mario", "Zelda", "Pokémon", "GTA", "FIFA", "Call of Duty", "The Sims", "Dark Souls"] },
        { label: "Langues du monde", cat: "GÉO", emoji: "🗣️", answers: ["Mandarin", "Espagnol", "Anglais", "Hindi", "Arabe", "Bengali", "Portugais", "Russe", "Japonais", "Swahili"] },
        { label: "Prix Nobel de littérature", cat: "LIT", emoji: "📚", answers: ["Albert Camus", "Gabriel García Márquez", "Toni Morrison", "Samuel Beckett", "Patrick Modiano", "Orhan Pamuk", "Peter Handke", "Jean-Paul Sartre (refusé)", "Svetlana Aleksievitch"] },
        { label: "Grandes découvertes scientifiques", cat: "SCIENCE", emoji: "🔬", answers: ["La pénicilline", "La gravité (Newton)", "La radioactivité (Curie)", "La structure de l'ADN", "Le vaccin (Jenner)", "L'électricité (Franklin)", "La relativité (Einstein)", "Le big bang"] },
        { label: "Batailles célèbres de l'histoire", cat: "HIST", emoji: "⚔️", answers: ["Waterloo", "Marathon", "Azincourt", "Stalingrad", "Trafalgar", "Austerlitz", "Thermopyles", "Verdun", "Midway"] },
        { label: "Philosophes antiques", cat: "PHILO", emoji: "📖", answers: ["Socrate", "Platon", "Aristote", "Épicure", "Diogène", "Héraclite", "Thalès", "Pythagore", "Xénophon", "Parménide"] },
        { label: "Sports olympiques d'été", cat: "SPORT", emoji: "🏅", answers: ["Natation", "Athlétisme", "Gymnastique", "Escrime", "Judo", "Aviron", "Équitation", "Cyclisme", "Volleyball", "Basketball"] },
        { label: "Monuments du monde classés à l'UNESCO", cat: "ART", emoji: "🏛️", answers: ["Colisée de Rome", "Taj Mahal", "Pyramides de Gizeh", "Machu Picchu", "Angkor Vat", "Stonehenge", "Alhambra de Grenade", "Versailles", "Acropole d'Athènes"] },
        { label: "Inventions du XXe siècle", cat: "SCIENCE", emoji: "💡", answers: ["Internet", "Avion (1903)", "Pénicilline (1928)", "Télévision", "Ordinateur", "Téléphone portable", "Bombe atomique", "Fusée spatiale", "Transistor", "ADN décrypté"] },
      ],
    },
  },
...

  {
    ...
    content: {
      ...
      items: [
        ...
        { q: "En quelle année a débuté la Première Guerre mondiale ?", r: "1914", cat: "HIST" },
        { q: "Quelle est la hauteur du Mont Blanc ?", r: "4 808 m", cat: "GÉO" },
        { q: "Combien de livres dans la Bible (canon protestant) ?", r: "66", cat: "CULTURE" },
        { q: "En quelle année a été fondée l'ONU ?", r: "1945", cat: "HIST" },
        { q: "Quelle est la distance Terre–Lune (en km) ?", r: "~384 400 km", cat: "SCIENCE" },
        { q: "En quelle année Napoléon a-t-il été couronné empereur ?", r: "1804", cat: "HIST" },
        { q: "Combien de planètes dans le système solaire ?", r: "8", cat: "SCIENCE" },
        { q: "En quelle année la chute du mur de Berlin a-t-elle eu lieu ?", r: "1989", cat: "HIST" },
        { q: "Quel est l'âge approximatif de l'univers (milliards d'années) ?", r: "~13,8 milliards d'années", cat: "SCIENCE" },
      ],
    },
  },

  {
    ...
    content: {
      ...
      items: [
        ...
        { text: "L'eau bout à 100 °C au niveau de la mer.", answer: "VRAI", cat: "SCIENCE" },
        { text: "Le python est venimeux.", answer: "FAUX", cat: "NATURE", note: "Le python est constricteur, pas venimeux." },
        { text: "La Chine est le plus grand pays du monde en superficie.", answer: "FAUX", cat: "GÉO", note: "C'est la Russie (17 M km²)" },
        { text: "Les Vikings ont atteint l'Amérique avant Christophe Colomb.", answer: "VRAI", cat: "HIST", note: "Leif Erikson vers l'an 1000" },
        { text: "Le lion est le félin le plus rapide.", answer: "FAUX", cat: "NATURE", note: "C'est le guépard (~110 km/h)" },
        { text: "La Tour de Babel est mentionnée dans la Bible.", answer: "VRAI", cat: "CULTURE" },
        { text: "Shakespeare est né et mort le même jour (23 avril).", answer: "VRAI", cat: "LIT", note: "Naissance supposée et mort le 23 avril, à 52 ans." },
        { text: "La lumière met environ 8 minutes à aller du Soleil à la Terre.", answer: "VRAI", cat: "SCIENCE" },
      ],
    },
  },
...

  {
    ...
    content: {
      ...
      items: [
        ...
        { word: "PYRAMIDE", forbidden: ["Égypte", "pharaon", "triangle"] },
        { word: "ÉVOLUTION", forbidden: ["Darwin", "espèce", "sélection"] },
        { word: "CATHÉDRALE", forbidden: ["gothique", "église", "vitrail"] },
        { word: "ASTRONOMIE", forbidden: ["étoile", "planète", "télescope"] },
        { word: "EMPIRE", forbidden: ["Rome", "Napoléon", "conquête"] },
        { word: "TSUNAMI", forbidden: ["vague", "mer", "Japon"] },
        { word: "ÉPIDÉMIE", forbidden: ["maladie", "virus", "contamination"] },
        { word: "TREMBLEMENT DE TERRE", forbidden: ["séisme", "secousse", "Richter"] },
        { word: "ALCHIMIE", forbidden: ["or", "potion", "médiéval"] },
        { word: "DIASPORA", forbidden: ["peuple", "migration", "disperser"] },
      ],
    },
  },

  {
    ...
    content: {
      ...
      items: [
        ...
        { q: "Les 5 pays avec le plus de médailles aux JO de tous les temps", answers: ["États-Unis", "URSS/Russie", "Allemagne", "Grande-Bretagne", "Chine"], cat: "SPORT" },
        { q: "Les 5 plus grandes villes du monde par population", answers: ["Tokyo", "Delhi", "Shanghai", "Dhaka", "São Paulo"], cat: "GÉO" },
        { q: "Les 5 religions avec le plus de fidèles", answers: ["Christianisme", "Islam", "Hindouisme", "Bouddhisme", "Sikhisme"], cat: "CULTURE" },
        { q: "Les 5 pays producteurs de pétrole les plus importants", answers: ["États-Unis", "Arabie saoudite", "Russie", "Canada", "Irak"], cat: "GÉO" },
      ],
    },
  },
...

  {
    ...
    content: {
      ...
      items: [
        { label: "Le fonctionnement du Parlement européen", cat: "POL", emoji: "⚖️", answers: ["Élu au suffrage universel", "Siège à Strasbourg et Bruxelles", "Codecision avec le Conseil de l'UE", "751 eurodéputés (avant Brexit)", "Groupes politiques transnationaux"] },
        { label: "La Route de la Soie", cat: "HIST", emoji: "🗺️", answers: ["Relie la Chine à la Méditerranée", "Commerciait soie, épices, or", "VIIe siècle av. J.-C. au XVe", "Passait par Samarcande et Bagdad", "Vecteur de diffusion des religions et des maladies"] },
        { label: "La théorie de la relativité d'Einstein", cat: "SCIENCE", emoji: "🔬", answers: ["E = mc²", "Restreinte (1905) et générale (1915)", "Espace-temps courbé par la masse", "Temps ralenti près d'objets massifs", "Prédit les trous noirs et les ondes gravitationnelles"] },
        { label: "L'histoire du canal de Suez", cat: "HIST", emoji: "🏛️", answers: ["Inauguré en 1869", "Relie la Mer Rouge à la Méditerranée", "Construit par Ferdinand de Lesseps", "Nationalisé par Nasser en 1956", "Crise de Suez → retrait franco-britannique"] },
        { label: "La philosophie de Nietzsche", cat: "PHILO", emoji: "📖", answers: ["'Dieu est mort'", "Surhomme (Übermensch)", "Volonté de puissance", "Éternel retour", "Critique du nihilisme et de la morale chrétienne"] },
        { label: "Le système de castes en Inde", cat: "HIST", emoji: "🌏", answers: ["4 varnas + intouchables", "Brahmanes (prêtres), Kshatriyas (guerriers), Vaishyas (marchands), Shudras (serviteurs)", "Discriminations formellement abolies en 1950", "Gandhi appelait les intouchables 'Harijans'", "Affirmative action (réserves) en place"] },
        { label: "Les trous noirs", cat: "SCIENCE", emoji: "🌑", answers: ["Gravité si forte que rien n'en échappe", "Formés par effondrement d'étoiles massives", "Horizon des événements", "Singularité au centre", "Hawking : rayonnement thermique des trous noirs"] },
        { label: "L'architecture gothique", cat: "ART", emoji: "🏰", answers: ["Arc brisé + arc-boutant + voûte en ogive", "XIIe au XVIe siècle", "Notre-Dame de Paris, Chartres, Cologne", "Vitraux colorés, rosaces", "Remplacé le roman, nef très haute"] },
        { label: "La géopolitique du pétrole", cat: "POL", emoji: "🛢️", answers: ["OPEP fondée en 1960", "Arabie saoudite 1er exportateur mondial", "Choc pétrolier de 1973", "Pétrole en dollar (pétrodollar)", "Ressource finie, enjeu de conflits armés"] },
        { label: "Le fonctionnement de la Bourse", cat: "TECH", emoji: "💹", answers: ["Actions = parts d'entreprises", "NYSE, Nasdaq, Euronext", "Cours fixé par offre et demande", "CAC 40 = indice des 40 plus grandes valeurs françaises", "Krach = chute brutale des cours"] },
        { label: "Les règles du cricket", cat: "SPORT", emoji: "🏏", answers: ["11 joueurs par équipe", "Batteur vs lanceur (bowler)", "Wickets à protéger", "Test matches : 5 jours", "Populaire en Angleterre, Inde, Pakistan, Australie"] },
        { label: "Le fonctionnement des algorithmes", cat: "TECH", emoji: "💻", answers: ["Suite d'instructions finies et ordonnées", "Tri, recherche, recommandation", "Complexité temporelle (O(n), O(log n))", "Utilisés dans les IA et moteurs de recherche", "Algorithme d'Euclide (PGCD) parmi les plus anciens"] },
      ],
    },
  },
...

  {
    ...
    content: {
      ...
      items: [
        ...
        { word: "Zénith", def: "Point du ciel situé à la verticale de l'observateur ; point culminant d'une trajectoire." },
        { word: "Oxymoron", def: "Figure de style associant deux mots de sens contraires en une formule paradoxale (ex. « soleil noir »)." },
        { word: "Néologisme", def: "Mot nouvellement créé ou sens nouveau donné à un mot existant dans une langue." },
        { word: "Mnémotechnique", def: "Procédé qui facilite la mémorisation par des associations d'idées artificielles." },
        { word: "Épigraphe", def: "Citation placée en tête d'un livre ou d'un chapitre pour en éclairer le sens." },
        { word: "Métonymie", def: "Figure de style qui désigne une chose par une autre qui lui est liée (ex. « boire un verre »)." },
        { word: "Catharsis", def: "Purification des passions par l'art dramatique ; concept développé par Aristote." },
        { word: "Anachronisme", def: "Erreur qui consiste à placer un fait, une personne ou un objet dans une époque où il ne peut exister." },
      ],
    },
  },

  {
    ...
    content: {
      ...
      items: [
        ...
        { q: "Capitale du Brésil ?", r: "Brasília", cat: "GÉO" },
        { q: "Qui a peint la Joconde ?", r: "Léonard de Vinci", cat: "ART" },
        { q: "Combien font 7 × 8 ?", r: "56", cat: "MATH" },
        { q: "Quelle est la planète rouge ?", r: "Mars", cat: "SCIENCE" },
        { q: "Qui a écrit Roméo et Juliette ?", r: "William Shakespeare", cat: "LIT" },
        { q: "Dans quel pays se trouve la Tour de Pise ?", r: "Italie", cat: "GÉO" },
        { q: "Combien de jours dans une année bissextile ?", r: "366", cat: "SCIENCE" },
        { q: "Qui a peint « La Nuit étoilée » ?", r: "Vincent van Gogh", cat: "ART" },
        { q: "Quel est le plus long fleuve du monde ?", r: "Le Nil ou l'Amazone (débat) — ~6 650 km pour le Nil", cat: "GÉO" },
        { q: "Quel animal est le symbole de la paix ?", r: "La colombe", cat: "CULTURE" },
      ],
    },
  },

  {
    ...
    content: {
      ...
      items: [
        ...
        { topic: "Le colonialisme a été, malgré ses crimes, une force de modernisation pour certaines régions.", cat: "HIST" },
        { topic: "La démocratie représentative est une illusion — le pouvoir réel appartient toujours aux élites.", cat: "POL" },
        { topic: "Les langues minoritaires devraient être sacrifiées au profit de langues plus utiles mondialement.", cat: "CULTURE" },
        { topic: "Les réseaux sociaux ont fait plus de tort à la démocratie que la censure directe.", cat: "TECH" },
        { topic: "Le sport de haut niveau devrait être entièrement séparé de la politique.", cat: "SPORT" },
      ],
    },
  },
...

  {
    ...
    content: {
      ...
      items: [
        ...
        { q: "Quelle est la capitale de la Norvège ?", r: "Oslo", cat: "GÉO" },
        { q: "Qui a énoncé la loi de la gravitation universelle ?", r: "Isaac Newton", cat: "SCIENCE" },
        { q: "Quel est le plus grand pays d'Afrique (superficie) ?", r: "L'Algérie", cat: "GÉO" },
        { q: "Qui a dit « Je pense donc je suis » ?", r: "René Descartes", cat: "PHILO" },
        { q: "Quel est le symbole chimique de l'or ?", r: "Au", cat: "SCIENCE" },
        { q: "En quelle langue a été écrit « Don Quichotte » ?", r: "Espagnol (castillan)", cat: "LIT" },
        { q: "Quelle est la plus petite planète du système solaire ?", r: "Mercure", cat: "SCIENCE" },
        { q: "Qui a écrit « Crime et Châtiment » ?", r: "Fiodor Dostoïevski", cat: "LIT" },
      ],
    },
  },
